      ...
      >
        ...
        <div
          style={{
            ...
            background:
              "linear-gradient(135deg, var(--secondary) 0%, #f0c200 100%)",
            color: "var(--dark)",
            textAlign: "center",
          }}
        >
          ...
          >
            Become part of the struggle for democracy
          </p>
        </div>
        ...
        <div style={{ padding: "clamp(2rem, 5vw, 2.5rem)" }}>
          ...
          >
            ...
            >
              By creating an account, you agree to uphold the principles of
              PUDEMO as outlined in our manifesto and constitution.
            </div>
